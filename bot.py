...
def cottage_2(message):
    bot.send_message(message.chat.id,
        ...
        "📸 [Посмотреть фото и подробности](https://t.me/breezuzb/710)",
        parse_mode="Markdown"
    )
...
def cottage_4(message):
    bot.send_message(message.chat.id,
        ...
        "— Доступ к бассейну\n"
        "— Заезд в 10:00, выезд до 9:00\n\n"
        "📸 [Посмотреть фото и подробности](https://t.me/breezuzb/714)",
        parse_mode="Markdown"
    )
...
def cottage_5(message):
    bot.send_message(message.chat.id,
        ...
        "— Доступ к бассейну\n"
        "— Заезд в 10:00, выезд до 9:00\n\n"
        "📸 [Посмотреть фото и подробности](https://t.me/breezuzb/705)",
        parse_mode="Markdown"
    )
...
def standard_2(message):
    bot.send_message(message.chat.id,
        ...
        "— Заезд в 10:00, выезд до 9:00\n\n"
        "📸 [Посмотреть фото и подробности](https://t.me/breezuzb/718)",
        parse_mode="Markdown"
    )
...
def standard_4(message):
    bot.send_message(message.chat.id,
        ...
        "— Заезд в 10:00, выезд до 9:00\n\n"
        "📸 [Посмотреть фото и подробности](https://t.me/breezuzb/714?single)",
        parse_mode="Markdown"
    )
...
def topchan_with_pool(message):
    bot.send_message(message.chat.id,
        ...
        "📸 [Посмотреть фото и подробности](https://t.me/breezuzb/788?single)",
        parse_mode="Markdown"
    )
...
def sauna_info(message):
    bot.send_message(message.chat.id,
        ...
        "📸 [Посмотреть фото и подробности](https://t.me/BreezTashMoreUzbekistan/32955)",
        parse_mode="Markdown"
    )
...
def table_info(message):
    bot.send_message(message.chat.id,
        ...
        "📸 [Посмотреть фото и подробности](https://t.me/breezuzb/791?single)",
        parse_mode="Markdown"
    )
